...
<xsl:template name="textstyleclass">
  <xsl:choose>
    ...
    <xsl:when test="@styleclass = 'header2'"><xsl:attribute name="style">font-family:Verdana; font-size:10pt; font-weight:bold; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#1e3893; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Normal'"><xsl:attribute name="style">font-family:Verdana; font-size:9pt; font-weight:normal; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Comment'"><xsl:attribute name="style">font-family:Verdana; font-size:9pt; font-weight:normal; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Heading1'"><xsl:attribute name="style">font-family:Tahoma; font-size:14pt; font-weight:bold; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#feeecd; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'chaphead'"><xsl:attribute name="style">font-family:'Times New Roman'; font-size:16pt; font-weight:bold; font-style:normal; text-decoration:underline; text-transform:none; vertical-align:baseline; color:#ffffff; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'heading2'"><xsl:attribute name="style">font-family:Tahoma; font-size:12pt; font-weight:bold; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#feeecd; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Image Caption'"><xsl:attribute name="style">font-family:Verdana; font-size:8pt; font-weight:bold; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Notes'"><xsl:attribute name="style">font-family:Verdana; font-size:9pt; font-weight:normal; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'заг1'"><xsl:attribute name="style">font-family:Tahoma; font-size:12pt; font-weight:bold; font-style:normal; text-decoration:none; text-transform:none; vertical-align:baseline; color:#ffffff; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'меню'"><xsl:attribute name="style">font-family:Verdana; font-size:8pt; font-weight:normal; font-style:normal; text-decoration:underline; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'рисунок'"><xsl:attribute name="style">font-family:Arial; font-size:8pt; font-weight:normal; font-style:italic; text-decoration:none; text-transform:none; vertical-align:baseline; color:#000000; background-color:transparent; letter-spacing:normal; letter-scaling:100%; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="parastyleclass">
  <xsl:choose>
    ...
    <xsl:when test="@styleclass = 'header2'"><xsl:attribute name="style">text-align:center; text-indent:0px; margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:avoid; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Normal'"><xsl:attribute name="style">text-align:justify; text-indent:19px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Comment'"><xsl:attribute name="style">text-align:justify; text-indent:19px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Heading1'"><xsl:attribute name="style">text-align:center; text-indent:0px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'chaphead'"><xsl:attribute name="style">text-align:center; text-indent:0px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'heading2'"><xsl:attribute name="style">text-align:center; text-indent:0px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Image Caption'"><xsl:attribute name="style">text-align:justify; text-indent:19px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'Notes'"><xsl:attribute name="style">text-align:justify; text-indent:19px; margin-top:5px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
    <xsl:when test="@styleclass = 'меню'"><xsl:attribute name="style">text-align:left; text-indent:0px; margin-top:0px; margin-right:0px; margin-bottom:0px; margin-left:0px; line-height:1.0; background-color:transparent; white-space:normal; page-break-inside:auto; page-break-after:auto; border:none; tabstops:none; <xsl:value-of select="@style"/></xsl:attribute></xsl:when>
